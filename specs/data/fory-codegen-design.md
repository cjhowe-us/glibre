...
```cpp
// AUTO-GENERATED by glibre-foryc — do not edit.
// blake3 preimage: per-schema entries of (fqn_utf8 ":" version_le ":" schema_source_blake3),
// entries LF-separated, FQN-sorted (Unicode code-point order). Stable across hosts;
// recomputed on every schema change. See reviews/decisions/plugin-abi.md §"ABI Hash Function" rule 1.
